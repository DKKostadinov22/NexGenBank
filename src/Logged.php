...
<body>
    <script src="../script/Logged.js" defer></script>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../pages/About-Us-unverified.html">About Us</a>
          </li>
...
<div class="card text-center" id="card-body">
    <div class="card-body">
            <div class="container">
                ...
                <!--Log out button-->
                <button onclick="goToIndex()" class="log-outbtn"><a href="../index.html">Log out</a></button>
                <br><hr>
